...
public class ThermalPrinter {
    ...
    public void printReceipt(String bankName, String atm_name, String accountNumber, double amount, double balance, String type) {
        ...
        try {
            ...
            sendCommand(printer, new byte[]{0x1D, 0x21, 0x00});
